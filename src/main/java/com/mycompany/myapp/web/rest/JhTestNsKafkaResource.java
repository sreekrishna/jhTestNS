...
@RestController
@RequestMapping("/api/jh-test-ns-kafka")
public class JhTestNsKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhTestNsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhTestNsKafkaResource(KafkaProperties kafkaProperties) {
